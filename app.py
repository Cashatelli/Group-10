...
with app.app_context():
    ...
    cars = [ 
        ...
        #Hatchback Cars
        Car(vin="KNAFK5A88H5719594", cartype="Hatchback", make="Kia", model="Forte5 LX", year=2017, seats=5, ppd=95, mpg=25, mileage=12799, location="Raleigh", image="hb_kiaForte5.jpg"),
        ...
        Car(vin="SHHFK7H58HU233486", cartype="Hatchback", make="Honda", model="Civic EX", year=2017, seats=5, ppd=88, mpg=31, mileage=89592, location="Raleigh", image="hb_hondaCivic.jpg"),
        ...
        Car(vin="JTNC4MBE3M3116049", cartype="Hatchback", make="Toyota", model="Corolla XSE", year=2021, seats=5, ppd=74, mpg=30, mileage=33401, location="Williamston", image="hb_toyotaCorolla.jpg"),
        ...
        Car(vin="WMW73DH03P2T40658", cartype="Hatchback", make="Mini Cooper", model="John Cooper Works", year=2023, seats=4, ppd=83, mpg=25, mileage=7008, location="Winston Salem", image="hb_mini.jpg"),
        ...
        Car(vin="3VWYT7AU0FM032499", cartype="Hatchback", make="Volkswagen", model="GTI S", year=2015, seats=5, ppd=90, mpg=25, mileage=119845, location="Conover", image="hb_VW.jpg"),
        Car(vin="JM1BPBJY1P1604021", cartype="Hatchback", make="Mazda", model="Mazda3 Turbo", year=2023, seats=5, ppd=85, mpg=23, mileage=9405, location="Burlington", image="hb_mazdaTurbo.jpg"),
        Car(vin="3HGGK5H88FM728818", cartype="Hatchback", make="Honda", model="Fit EX", year=2015, seats=5, ppd=101, mpg=32, mileage=93968, location="Walkertown", image="hb_hondaFit.jpg"),
        Car(vin="19XFL2H81NE000532", cartype="Hatchback", make="Honda", model="Civic Sport", year=2022, seats=5, ppd=91, mpg=29, mileage=17625, location="Concord", image="hb_hondaCivSport.jpg"),
        Car(vin="SHHFK7H90JU233202", cartype="Hatchback", make="Honda", model="Civic Sport Touring", year=2018, seats=5, ppd=72, mpg=31, mileage=95548, location="Wilkesboro", image="hb_hondaTouring.jpg"),
        ...
        #Vans
        Car(vin="1GCWGBFP8P1103AA7", cartype="Van", make="Chevrolet", model="Express 2500", year=2023, seats=12, ppd=85, mpg=14, mileage=3046, location="Reidsville", image="van_chevExpress.jpg"),
        Car(vin="H1FTYR1YG9GKA1AA7", cartype="Van", make="Honda", model="Odyssey EX L", year=2022, seats=7, ppd=90, mpg=24, mileage=19209, location="Fuquay Varina", image="van_odysseyEXL.jpg"),
        ...
        Car(vin="3C6LRVBG8ME525AA6", cartype="Van", make="Honda", model="Odyssey LX", year=2019, seats=7, ppd=105, mpg=18, mileage=75675, location="Indian Trail", image="van_odysseyLX.jpg"),
        Car(vin="WD4PF0CD6KP026AA5", cartype="Van", make="Mercedes-Benz", model="Sprinter 2500", year=2019, seats=12, ppd=94, mpg=18, mileage=9730, location="Madison", image="van_sprinter2500.jpg"),
        Car(vin="W1XV0FEYXM3918AA4", cartype="Van", make="Mercedes-Benz", model="Metris", year=2021, seats=7, ppd=82, mpg=18, mileage=20308, location="Madison", image="van_metris.jpg"),
        ...
        Car(vin="1FTBW9CGXLKA67BA6", cartype="Van", make="Toyota", model="Sienna XSE", year=2022, seats=7, ppd=90, mpg=20, mileage=180995, location="Wilson", image="van_sienna.jpg"),
        ...
        Car(vin="1FBZX2YG4GKA22AA4", cartype="Van", make="Ford", model="Transit XLT", year=2016, seats=12, ppd=83, mpg=22, mileage=69320, location="Lenoir", image="van_fordTrans.jpg"),
        Car(vin="1FTYR2CMXKKA14AA4", cartype="Van", make="Ford", model="Transit Base", year=2019, seats=15, ppd=99, mpg=15, mileage=11137, location="Asheboro", image="van_fordTransBase.jpg"),
        Car(vin="WD3PE7CC0C5718AA1", cartype="Van", make="Kia", model="Carnival SX Prestige", year=2022, seats=7, ppd=70, mpg=22, mileage=17363, location="Thomasville", image="van_carnPrestige.jpg"),
        Car(vin="1FTBW1YK7PKA57AA4", cartype="Van", make="Kia", model="Carnival LX", year=2023, seats=7, ppd=95, mpg=23, mileage=321, location="Greensboro", image="van_kia.jpg"),
        Car(vin="3C6ERVDG5ME500AA1", cartype="Van", make="Honda", model="Odyssey Touring", year=2022, seats=7, ppd=88, mpg=24, mileage=12738, location="Burgaw", image="van_touring.jpg"),
